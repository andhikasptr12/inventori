...
<div class="container">
    ...
    <div class="card border-0">
        <div class="card-body">
            <form action="{{route('master-barang.update', $barangs->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control" value="{{$barangs->name}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="price" id="" class="form-control" value="{{$barangs->price}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
