        ...
        <main class="">
            <div class="jumbotron" style="background-image: linear-gradient(to right, #6dd5ed,#2193b0); color: #0f2027;">
                <div class="container">
                    ...
                    <nav class="navbar navbar-expand-md navbar-dark navbar-dark mt-3 border-top ">
                        <div class="container">
                                <!-- Left Side Of Navbar -->
                                <ul class="d-flex justify-content-center" style=" margin-top: 30px; text-transform: uppercase; ">
                                    ...
                                    <li class="nav-link mr-5 hover">
                                        <a href="{{route('daftarbarang.index')}}" class="nav-link text-dark">Daftar Barang</a>
                                    </li>
                                    <li class="nav-link mr-5 hover">
                                    ...
                                    <li class="nav-link dropdown">
                                        <a href="" class="nav-link dropdown-toggle text-dark" role="button" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                            Laporan
                                        </a>
